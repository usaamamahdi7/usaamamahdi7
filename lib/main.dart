...
List<ChatMessage> _chatData = [
  ChatMessage(sender: 'manka', text: 'sxp iwrn!', unreadCount: 2),
  ChatMessage(sender: 'xasan ali', text: 'Hello! How are you?', unreadCount: 4),
  ChatMessage(sender: 'usama', text: '! laganow?', unreadCount: 1),
  ChatMessage(sender: 'wllka weyn', text: 'taliye xagee!', unreadCount: 2),
  ChatMessage(sender: 'legend moha', text: 'wraa captan?', unreadCount: 4),
  ChatMessage(sender: 'Genaral shegow', text: 'Hey! What\'s up?', unreadCount:1),
];